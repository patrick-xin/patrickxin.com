...
isPublished: true
description: Build a react toast with tailwind, framer motion and zutstand by yourself.
toc: true
thumbnail: {
    "author": "brandi-redd",
...
- State Managment [Zutstand](https://github.com/pmndrs/zustand) 
...
### Add Animation and connect it to the store
