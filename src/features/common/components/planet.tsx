const Planet = () => {
  return (
    <div className="absolute my-auto mx-auto right-[10%] top-2/4">
      <svg
        className="h-96 w-96 -z-30 filter"
      ...
      >
        ...
        <g>
          <path
            className="fill-current m-2 text-snow animate-blob-spin origin-center"
